...
the frame). The primary focus is on systems-level optimisation and real-time performance
on constrained mobile hardware. All computation occurs entirely on the mobile device.
